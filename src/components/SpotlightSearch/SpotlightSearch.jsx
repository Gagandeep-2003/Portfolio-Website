  ...
  const fetchGeminiResponse = async (query, apiKey) => {
    try {
      ...
      const profileInfo = `
        ...
        - Skilled in JavaScript, TypeScript, HTML, CSS, and various frameworks
        - Experienced in building web applications, mobile apps, and interactive websites
        - Portfolio showcases projects in web development, UI/UX design, and software engineering
        - Education includes computer science background with focus on modern development practices
      ...
      const prompt = `
        You are an AI assistant embedded in Gagandeep Singh's portfolio website.
        Answer questions about Gagandeep based on this information:
        ${profileInfo}
        
        If the question is not related to Gagandeep's profile, skills, projects, or professional information,
        politely explain that you can only provide information about Gagandeep's professional profile.
